...
\note{With all of this knowledge, we create a simple decision tree in Figure~\ref{fig:decision_tree} that can be used for choosing an appropriate horizontal method given a workflow. \textbf{We need to discuss about the decision tree figure.}}
