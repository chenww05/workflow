...
WorkflowSim is a workflow simulator that extends from CloudSim~\cite{Calheiros2011} by providing support of task clustering, task scheduling and resource provisioning at the workflow level. It has been recently used in multiple workflow study areas~\cite{Chen2012, jrad2013broker, Chen-balanced-2013} and its correctness has been verified in~\cite{Chen2012a}. 
