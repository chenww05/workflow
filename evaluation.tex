...
\begin{figure}[!htb]
    ...
    \caption{Experiment 2: performance gain ($\mu$) over a control execution with different average data sizes for the LIGO workflow.}
...
\note{not sure whether it is right}
