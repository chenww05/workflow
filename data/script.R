...
c <- data.frame(read.csv("/Users/silva/Documents/isi/papers/2014/workflow/data/vc_cybershake.csv"))
 
c$alg <- factor (c$alg, levels = c("HRB","HIFB","HDB","HC"))
c$vc <- factor (c$vc, levels = c("VC-prior","VC-posterior","No-VC","VC-only"))

setEPS()
postscript(file="/Users/silva/Documents/isi/papers/2014/workflow/figures/results/vc_cybershake.eps", height=4)
