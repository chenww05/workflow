...
c <- data.frame(read.csv("/Users/silva/Documents/isi/pubs/2014/fgcs-taskclustering/data/resources.csv"))
 
c$alg <- factor (c$alg, levels = c("HRB","HIFB","HDB","HC"))
c$vms <- factor (c$vms, levels = c("5","10","15","20","25"))

setEPS()
postscript(file="/Users/silva/Documents/isi/pubs/2014/fgcs-taskclustering/resources.eps", height=4)
